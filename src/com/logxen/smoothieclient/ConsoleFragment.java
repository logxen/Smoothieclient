...
public class ConsoleFragment extends FragmentActivity {

    private final String TAG = ConsoleFragment.class.getSimpleName();
    ...
    private final SerialInputOutputManager.Listener mListener =
        ...
        public void onNewData(final byte[] data) {
            ConsoleFragment.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    ConsoleFragment.this.updateReceivedData(data);
                }
            });
        }
    };
